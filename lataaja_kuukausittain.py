...
filetype='.csv'
archivename='Happy'
#update timegap to update all regions timeframe parameter.
timegap='2006-01-01 2021-01-01'
#GB
pytrend.build_payload(kw_list,cat=0,timeframe=timegap,geo=location)
